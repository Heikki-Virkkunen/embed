...
/*
This example is the same as in FIG 1B in the article, in section 3.
*/
public class Demo
{
  ...
  throws Exception
  {
    ...
    //Note: We use three embed commands to create the database
    //beacuse we want to get same ids in the database as is in
    //the figure 1B. Otherwise two would be enough.
