...
This example demonstrates that the embed method is applicable
for very complex update operations.


The file 
  demoComplexExampleFixedNodes.pdf
contains graphical description of this example.
...
6)
Check the results in the created database friends.db
